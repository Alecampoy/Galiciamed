...
setwd('/home/ale/Documentos/GitHub/Galiciamed/')
```
...
every_file <- dir('/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/', recursive = TRUE, include.dirs = FALSE)
...
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figura-2-smn-principal/'
...
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figure-3-11genes-principal/'
...
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/Figure-3-11genes-supl/'
...
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figure-4A-clomipramine-gradiente-principal/'
...
# to save plots and data
# ggsave("Fig.4.png", device = 'png', path = 'output images/')
# ggsave("Fig.4.svg", device = 'svg', path = 'output images/')
# write_csv(Fig.4, "output data/Fig.4_data.csv")
```
...
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/Figure-4A-clomipramine-supl/'
...
# to save plots and data
# ggsave("Fig.4_supl.png", device = 'png', path = 'output images/')
# ggsave("Fig.4_supl.svg", device = 'svg', path = 'output images/')
# write_csv(Fig.4_supl, "output data/Fig.4_supl_data.csv")
```
...
# Every command is in a single chunk for easinses
# data_folder <- 'p:/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figure-4A-clomipramine-gradiente-principal/'
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figure-4B-desipramine-gradiente-principal/'
...
```{r, warning=FALSE, fig.width=10}
# Every command is in a single chunk for easinses
# data_folder <- 'p:/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed//'
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/Figure-4B-desipramine-supl/'
...
```{r, warning=FALSE, fig.width=10}
# Every command is in a single chunk for easinses
# data_folder <- 'p:/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figl/'
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figure-4C-amlodipine-gradiente-principal/'
...
# Every command is in a single chunk for easinses
# data_folder <- 'p:/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed//'
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/Figure-4C-amlodipine-supl/'
...
# data_folder <- 'p:/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figl/'
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed/figure-5-clomipramine-adulto-principal/'
Fig.5 <- process_experiment(data_folder) %>%
  mutate(Condition = factor(Condition, levels = c("control", "amlodipine-25", "amlodipine-100"))) # ordered factors

### Data Standarization

standarization_factors_Fig.5 <-
  Fig.5 %>% filter(Condition == 'control') %>% group_by(Date) %>% summarise(
    control_mean_Sum_IntDen = mean(Sum_IntDen),
    control_sd_Sum_IntDen = sd(Sum_IntDen),
  )
...
Fig.5 <-
  Fig.5 %>% right_join(standarization_factors_Fig.5, by = "Date") %>%
  mutate(
    stand_Sum_IntDen = (Sum_IntDen - control_mean_Sum_IntDen) / control_sd_Sum_IntDen
    )
...
# Fig.5 %>% group_by(Date) %>% cohens_d(Sum_IntDen ~ Condition, ref.group = 'control')
...
Fig.5 %>%
  ...
  theme_bw(base_size = 12) +
  theme(legend.position = 'none', panel.grid.minor = element_blank(), axis.text.x = element_text(size = 11, face = "italic")) + 
  stat_pvalue_manual(stat.test_Fig.5, label = "p.adj.signif", x = 'x')
# Note, the position of the significance symbols is in the stat.test DF
...
Fig.5_supl <- process_experiment(data_folder) %>%
  mutate(Condition = factor(Sample)) # to use the sample repetition as the condition
levels(Fig.5_supl$Condition) <- c("amlodipine-100_rep1", "amlodipine-100_rep2", "control", "control")  # changing the levels name and grouping the controls

...
Every experiment is stored in an independent folder. Every condition of that experiment is stored in a subfolder with name structure *CONDITION - DATE*. Note that all control folders have been renamed to *control - date*
...
For Fig.2 a single two-sample t-test between populations is applied.
...
data_folder <- '/home/ale/pCloudDrive/CABD/Lab Manolo Muñoz/Ana Maria Brokate/datos paper Galiciamed//'
...
Fig.4C_supl <- process_experiment(data_folder) %>%
  mutate(Condition = factor(Sample)) # to use the sample repetition as the condition
levels(Fig.4C_supl$Condition) <- c("control", "control", "desipramine-400", "desipramine-500_rep1", "desipramine-500_rep2" )  # changing the levels name and grouping the controls
